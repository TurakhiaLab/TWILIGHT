...
void parseArguments(int argc, char** argv)
{
    ...
    alignDesc.add_options()
        ...
        ("max-subtree,m", po::value<int>(), "Maximum number of leaves in a subtree. Default: unlimited, or 1000 in --accurate mode.")
        ("remove-gappy,r", po::value<float>()->default_value(0.0), "Threshold for removing gappy columns. Set to 0 for automatic selection, 1 to disable this feature, or any other value to use a user-defined threshold.")
