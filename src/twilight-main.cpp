...
void parseArguments(int argc, char** argv)
{
    ...
    mainDesc.add_options()
        ...
        ("match",      po::value<float>()->default_value(40), "Match score.")
        ("mismatch",   po::value<float>()->default_value(-7), "Mismatch penalty for transversions.")
        ("transition", po::value<float>()->default_value(17), "Score for transitions")
        ("gap-open",   po::value<float>()->default_value(-140), "Gap-Open penalty")
        ("gap-extend", po::value<float>()->default_value(-10), "Gap-Extend penalty")
